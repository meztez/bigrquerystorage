...
#include "googleapis/google/cloud/bigquery/storage/v1/arrow.pb.h"
#include "googleapis/google/cloud/bigquery/storage/v1/stream.pb.h"
#include "googleapis/google/cloud/bigquery/storage/v1/storage.pb.h"
#include "googleapis/google/cloud/bigquery/storage/v1/storage.grpc.pb.h"
#include <Rcpp.h>
...
public:
  BigQueryReadClient(std::shared_ptr<Channel> channel, const std::string& client_info)
