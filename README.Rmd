...
If it detects `Rtools42`, it should be able to install dependencies from CRAN or bintray.
Make sure that your PATH environment variable includes both `%R_HOME%/bin/x64` and `%RTOOLS42_HOME%/mingw64/bin`.
